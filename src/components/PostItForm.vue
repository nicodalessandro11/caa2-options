<template>
  <div class="postit-form">
    <form class="postit-form__form" @submit.prevent="submitForm">
      <!-- Title Field -->
      ...
      <div class="postit-form__form-group">
        ...
        <input type="text" id="image" v-model="postItData.image" />
      </div>
...
export default {
  ...
  methods: {
    submitForm() {
      // Here we will handle the logic for submitting the form via API
      console.log("Form Submited", this.postItData);
    },
  },
};
</script>
